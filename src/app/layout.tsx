...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      "/energyWeekLogo.png",
      { url: "/energyWeekLogo.png", type: "image/png", sizes: "16x16" },
      { url: "/energyWeekLogo.png", type: "image/png", sizes: "32x32" },
      { url: "/energyWeekLogo.png", type: "image/png", sizes: "64x64" },
    ],
    shortcut: ["/energyWeekLogo.png"],
    apple: [{ url: "/energyWeekLogo.png" }],
  },
};
